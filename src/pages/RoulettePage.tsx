...
export default function RoulettePage() {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <Link
        to="/"
        className="card-glass fixed left-4 top-4 z-50 flex h-11 items-center gap-1.5 rounded-full px-4 text-sm font-bold text-white/70 transition hover:text-amber-300"
      >
